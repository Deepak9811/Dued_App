...
export default  ({ navigation }) => ({
    ...
    headerTitle : (a)=>{
        ...
        return <Text style={[a.style,{maxWidth:200,textAlign:'center'}]}>{_(a.children)}{settings.isProduction?"":<Text style={{fontSize:10,color:'red'}}>{"\n"}TEST TEST TEST</Text>}</Text>;
    },
...
/*
       ...
       // return <Button style={{marginRight:10,marginTop:Platform.OS=='android'?1:0}} label={_("LOGIN")} type={'black-small'} onPress={()=>navigation.navigate('LoginInside')} />;
