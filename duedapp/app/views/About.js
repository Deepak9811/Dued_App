...
class CurrentView extends React.Component {
    ...
    componentDidMount = async ()=>{
        ...
        API.getAbout({},(err,dt,showApiErrors)=>{
            ...
            this.setState({terms:dt.html.length==0?"Empty document":dt.html});
    ...
    render() {
        ...
        return (<View scrolls={true} style={{flex:1,flexGrow:1,backgroundColor:'rgba(0,12,46,1)'}} offsetCall={this.offsetCall}>
            ...
            <View style={{marginTop:-20,flex:1}}>
                <Heading size={2} style={{padding:30,paddingBottom:18,paddingLeft:15}}>{_('About')}</Heading>
